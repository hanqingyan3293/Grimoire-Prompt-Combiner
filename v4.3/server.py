...
for d in [PRESETS_DIR, HISTORY_DIR, SNAPSHOTS_DIR, CUSTOM_DIR]:
...
if __name__ == "__main__":
    print("=" * 50)
    print("  魔导书 v3.1 - AI绘画提示词组合器")
    print("  访问 http://127.0.0.1:5813")
    print("=" * 50)
    app.run(host="127.0.0.1", port=5813, debug=False)
